package com.example.sportsbuddy.Fragments;
...
import com.example.sportsbuddy.User;
import com.example.sportsbuddy.UserAdapter;
        ...
        referenc.addValueEventListener ( new ValueEventListener () {
            ...
            public void onDataChange (@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot:dataSnapshot.getChildren ()){
                    ...
                    if(!firebaseUser.getUid ().equals ( user.getFirstName () )){
                        mUsers.add ( user );
